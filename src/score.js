...
export const score = {
    ...
    update_scoreboard: function (ctx) {
        ...
        this.draw_score_component(ctx, assets.x, this.x, 0, param);
        this.draw_score_component(ctx, assets.o, this.o, 1, param);
        this.draw_score_component(ctx, assets.cats, this.cats, 2, param);

    },

    draw_score_component: function (ctx, img, score, position, param) {
